export default {
  ...
  "Own your information": "Administra tus datos personales. Tú decides cuándo y con quién lo compartes.",
  "Get access to many services": "Obtenga acceso a muchos servicios.",
  "Enjoy perks and benefits": "Disfrute de los beneficios y beneficios de obtener acceso a los servicios con un solo clic.",
  ...
  "Receive your identity verification with one click": "Reciba su identidad y datos personales verificados con solo unos pocos clics.",
  ...
  "insuranceDescription": "Sí, necesitas un seguro de auto. Consíguelo con solo un clic. Demuestre que es un conductor responsable y obtenga un descuento en su tarifa mensual compartiendo su Insignia de Conductor Seguro.",
  ...
  "rideSharingDescription": "Conviértase en un Conductor Ride Away y gane dinero en su propio tiempo. ¡Pero no construyas tu puntaje desde cero! Aumente su puntaje de conductor con credenciales de reputación de otros servicios y plataformas que ya ha almacenado en su aplicación uPort.",
  ...
  "To kick off the process get a proof of your driver's license": "Para comenzar el proceso, obtenga una prueba digital de su licencia de conducir.",
  "Buy a new car": "Compra un auto nuevo",
  "You can get it right away or get a loan for it": "Puede obtenerlo de inmediato pagando de su bolsillo, o ... ¡obtenga un préstamo! Para obtener la aprobación del préstamo y recibir una mejor tasa de interés, ahora puede compartir una prueba de su sistema de navegación de que conduce con seguridad.",
  "Become a driver": "Conviértete en un conductor",
  "Become a Driver": "Conviértete en un Conductor",
  "To drive other passengers you need car insurance": "Para convertirse en conductor en un servicio de transporte compartido, necesitará un seguro de automóvil. Afortunadamente, ya tienes todos los documentos necesarios almacenados en tu aplicación uPort. Todo lo que necesitas hacer es aplicar!",
